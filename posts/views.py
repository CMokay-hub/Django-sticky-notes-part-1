...
def post_list(request):
    ...
    :return: Rendered template with the list of posts.
    """
...
def post_detail(request, pk):
    ...
    :param request: The HTTP request object.
    :param pk: The primary key of the post.
    :return: Rendered template with the details of a specific post.
    """
...
def post_delete(request, pk):
    ...
    :return: Redirects to the post list view after deletion.
    """
    post = get_object_or_404(Post, pk=pk)
    post.delete()
    return redirect("post_list")
